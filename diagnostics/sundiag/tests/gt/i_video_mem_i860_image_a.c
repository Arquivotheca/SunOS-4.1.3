...
#ifndef lint
static  char sccsid[] = "@(#)i_video_mem_i860_image_a.c 1.1 92/07/30 Copyr 1990 Sun Micro";
#endif
...
/**********************************************************************/
void
i_video_mem_i860_image_a(ctxp, umcbp, kmcbp, fputs) 
/**********************************************************************/
...

{
	...
	txdat[0] = 'I';txdat[1] = 'M';txdat[2] = 'G';txdat[3] = 'A';
