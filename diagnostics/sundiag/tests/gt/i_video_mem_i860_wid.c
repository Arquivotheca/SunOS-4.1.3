...
#ifndef lint
static  char sccsid[] = "@(#)i_video_mem_i860_wid.c 1.1 92/07/30 Copyr 1990 Sun Micro";
#endif
...
/**********************************************************************/
void
i_video_mem_i860_wid(ctxp, umcbp, kmcbp, fputs) 
/**********************************************************************/
...

{
	...
	txdat[0] = 'W';txdat[1] = 'I';txdat[2] = 'D';
	txdat[3] = '-';txdat[4] = 'E';txdat[5] = 'r';txdat[6] = 'r';
	txdat[7] = ':';txdat[8] = ' ';txdat[9] = '\0';
	...
	for (y = 0; y < 1024; y++) {
	   ...
	   for ( x = 0; x < 1280; x++) {	
	      wr_data = (unsigned int)addr & 0x3ff;
	      *addr++ = wr_data;
	   }
	}
	...
	for (y = 0; y < 1024; y++) {
	   ...
	   for ( x = 0; x < 1280; x++) {	
	      ...
	      if (rd_data != wr_data)
		 goto error;
	      *addr++ = ~wr_data & 0x3ff;	/* write back complemented pattern */
	   }
	}
