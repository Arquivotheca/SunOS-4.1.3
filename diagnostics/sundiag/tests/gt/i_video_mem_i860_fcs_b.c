...
#ifndef lint
static  char sccsid[] = "@(#)i_video_mem_i860_fcs_b.c 1.1 92/07/30 Copyr 1990 Sun Micro";
#endif
...
/**********************************************************************/
void
i_video_mem_i860_fcs_b(ctxp, umcbp, kmcbp, fputs) 
/**********************************************************************/
...

{
	...
	txdat[0] = 'F';txdat[1] = 'c';txdat[2] = 's';txdat[3] = 'B';
