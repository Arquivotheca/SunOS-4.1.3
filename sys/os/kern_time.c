/*	@(#)kern_time.c 1.1 92/07/30 SMI; from UCB 7.5 7/21/87	*/
...
struct timezone tz;	/* XXX - for backward compatibility */
...
/*
 * Convert a timeval to 60ths of a second, for the benefit of old-style UNIX
 * interfaces that expect times in clock ticks.
 */
scale60(tvp)
