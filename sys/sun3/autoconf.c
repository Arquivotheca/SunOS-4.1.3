...
setcputype()
{
	 ...
	 */
	dvmasize = btoc(DVMASIZE) - NPMENTPERPMGRP;
	...
	case CPU_SUN3_110:
#ifndef SUN3_110
		panic("not configured for SUN3_110");
#endif !SUN3_110
		cpudelay = 3;
		break;
	case CPU_SUN3_60:
#ifndef SUN3_60
		panic("not configured for SUN3_60");
#endif !SUN3_60
		cpudelay = 3;
		break;
	case CPU_SUN3_E:
#ifndef SUN3_E
		panic("not configured for SUN3_E");
#endif !SUN3_E
		cpudelay = 3;
		break;
	}
	...
	int *bwmajor, *bwunit;
{
	...
	/*
	 * Now that we know the fb_type is a string, we simply compare it
	 * with entries in the table one by one.  This is the new style
	 * (Forth-based) boot prom.
	 */
