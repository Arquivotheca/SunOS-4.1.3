/* @(#)sdreg.h       1.1 92/07/30 Copyr 1989 Sun Micro */

/*
 * Defines for SCSI disk drives.
 */
#ifndef _sundev_sdreg_h
#define _sundev_sdreg_h

#define SD_FORMAT  		/* Enable on-line formatting mods */
#define SD_REPAIR		/* Enable auto disk repair */
...
/* fix block definitions */
#define	SD_REMAP		3
#define	SD_RECOVERABLE		2
#define	SD_REWRITE		1
#define	SD_OK			0
/*
...
#define SC_ZERO_WRITE		0x83	/* phony - for int use only */
...
#define SD_REMOVABLE		0x0010	/* removable media */
#define SD_DIAGNOSE		0x0020	/* report soft errors */
#define SD_IOCTL		0x0040	/* ioctl (format) cmd */
...
struct ccs_cache8 {
	...
	u_char	rd_retention	:4;	/* Read retention */
	u_char	wr_retention	:4;	/* Write retention */
	u_char	threshold_hb;		/* Prefetch threshold */
	u_char	threshold_lb;
	u_char	min_prefetch_hb;	/* Min. prefetch */
	u_char	min_prefetch_lb;
	u_char	max_prefetch_hb;	/* Max. prefetch */
	u_char	max_prefetch_lb;
	u_char	max_ceiling_hb;		/* Max. Prefetch ceiling */
	u_char	max_ceiling_lb;
};
