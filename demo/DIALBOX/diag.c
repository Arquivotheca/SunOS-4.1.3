...
diag_test()
{
	...
	/* insider knowledge about the operation of a dialbox, should be in an
		include file with defines or something */
	...
	/* disconnect the box from the windowing system */
