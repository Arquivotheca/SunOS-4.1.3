...
#ifndef lint
static	char sccsid[] = "@(#)colcrt.c 1.1 92/07/30 SMI"; /* from UCB 5.1 5/31/85 */
#endif not lint
	...
	char *argv[];
{
	...
	do {
		...
		for (;;) {
			/*
			** ASSERT: outline < 266
			** (We must have this, since if c=='_', the line
			** page[outline+1] is written and page[266] is the
			** last allocated line in the array.)
			*/
