...
struct op1_table spp_table[] =
{
	"nop", 0x0, 0x0, 0x0, SP_NOP, ST_DONTCARE,
	"nop", ssnan, 0x0, ssnan, SP_NOP, ST_DONTCARE,
	"negate", 0x0, sone, smone, SP_NEG, ST_INFINITY,
	"negate", 0x0, smone, sone, SP_NEG, ST_INFINITY,
	"negate", 0x0, ssnan, sone, SP_NEG, ST_ANAN,
	"absolute value", 0x0, smone, sone, SP_ABS, ST_INFINITY,
	"absolute value", 0x0, sone, sone, SP_ABS, ST_INFINITY,
	"absolute value", 0x0, ssnan, sone, SP_ABS, ST_ANAN,
	"float", 0x0, 1, sone, SP_FLT, ST_INFINITY,
	"float", 0x0, -1, smone, SP_FLT, ST_INFINITY,
	"float", 0x0, 4, sfour, SP_FLT, ST_INFINITY,
	"fix", 0x0, sone, 1, SP_FIX, ST_INFINITY,
	"fix", 0x0, smone, -1, SP_FIX, ST_INFINITY,
	"fix", 0x0, seight, 8, SP_FIX, ST_INFINITY,
	"fix", 0x0, spio2, 1, SP_FIX, ST_FINITEINEXACT,
	"fix", 0x0, ssnan, 2, SP_FIX, ST_ANAN,
	"square", 0x0, smone, sone, SP_SQR, ST_INFINITY,
	"square", 0x0, sone, sone, SP_SQR, ST_INFINITY,
	"square", 0x0, stwo, sfour, SP_SQR, ST_INFINITY,
	"square", 0x0, s1e2, s1e4, SP_SQR, ST_INFINITY,
	"square", 0x0, ssqrt2, 0x3fffffff, SP_SQR, ST_FINITEINEXACT,
	"square", 0x0, ssnan, stwo, SP_SQR, ST_ABNAN,
	"add", shalf, shalf, sone, SP_ADD, ST_INFINITY,
	"add", sone, sone, stwo, SP_ADD, ST_INFINITY,
	"add", sone, smone, szero, SP_ADD, ST_ZERO,
	"add", smone, stwo, sone, SP_ADD, ST_INFINITY,
	"add", spio2, spio2, spi, SP_ADD, ST_INFINITY,
	"add", sone, sminnorm, sone, SP_ADD, ST_FINITEINEXACT,
	"add", ssnan, spio2, spi, SP_ADD, ST_ANAN,
	"add", spio2, ssnan, spi, SP_ADD, ST_BNAN,
	"add", ssnan, ssnan, spi, SP_ADD, ST_ABNAN,
	"subtract", sone, shalf, shalf, SP_SUB, ST_INFINITY,
	"subtract", ssnan, shalf, shalf, SP_SUB, ST_ANAN,
	"multiply", sone, shalf, shalf, SP_MUL, ST_INFINITY,
	"multiply", 0x3FD3B200, 0xBD5BB555, 0xBDB5AF39, SP_MUL, ST_FINITEINEXACT,
	"multiply", 0xBD5BB555, 0x3FD3B200, 0xBDB5AF39, SP_MUL, ST_FINITEINEXACT,
	"multiply", sone, szero, szero, SP_MUL, ST_ZERO,
	"multiply", sfour, shalf, stwo, SP_MUL, ST_INFINITY,
	"multiply", ssqrt2, ssqrt2, 0x3fffffff, SP_MUL, ST_FINITEINEXACT,
	"multiply", ssnan, stwo, spi, SP_MUL, ST_BNAN,
	"divide", shalf, sone, shalf, SP_DIV, ST_INFINITY,
	"divide", shalf, sfour, s1o8, SP_DIV, ST_INFINITY,
	"divide", spi, stwo, spio2, SP_DIV, ST_INFINITY,
	"divide", stwo, ssqrt2, ssqrt2, SP_DIV, ST_FINITEINEXACT,
	"divide", ssnan, stwo, spio2, SP_DIV, ST_ANAN,
	"backwards subtract", shalf, sone, shalf, SP_BSUB, ST_INFINITY,
	"backwards subtract", smone, smone, szero, SP_BSUB, ST_ZERO,
	"backwards subtract", smone, ssnan, szero, SP_BSUB, ST_ANAN,
	"backwards divide", stwo, spi, spio2, SP_BDIV, ST_INFINITY,
	"backwards divide", ssqrt2, stwo, ssqrt2, SP_BDIV, ST_FINITEINEXACT,
	"backwards divide", stwo, ssnan, spio2, SP_BDIV, ST_ANAN,
	"compare with 0", sone, shalf, sone, SP_CMP0, ST_GREATERTHAN,
	"compare with 0", ssnan, ssnan, ssnan, SP_CMP0, ST_INVALIDOP,
...
struct op2_table dpp_table[] =
{
	"nop", dzero, dzero, dzero, DP_NOP, ST_DONTCARE,
	"negate", dzero, done, dmone, DP_NEG, ST_INFINITY,
	"negate", dzero, dmone, done, DP_NEG, ST_INFINITY,
	"abs value", dzero, dmone, done, DP_ABS, ST_INFINITY,
	"abs value", dzero, done, done, DP_ABS, ST_INFINITY,
	"float", dzero, 2, 0, dtwo, DP_FLT, ST_INFINITY,
	"float", dzero, -1, 0, dmone, DP_FLT, ST_INFINITY,
	"fix", 0x33333333, 0xaaaaaaaa, dfour, 4, 0xaaaaaaaa, DP_FIX, ST_INFINITY,
	"fix", 0x33333333, 0xaaaaaaaa, done, 1, 0xaaaaaaaa, DP_FIX, ST_INFINITY,
	"fix", 0x33333333, 0xaaaaaaaa, dmone, -1, 0xaaaaaaaa, DP_FIX, ST_INFINITY,
	"convert", 0, 0x55555555, deight, seight, 0x55555555, DP_CNV, ST_INFINITY,
	"square", dzero, dtwo, dfour, DP_SQR, ST_INFINITY,
	"square", dzero, d1e2, d1e4, DP_SQR, ST_INFINITY,
	"square", dzero, dsqrt2, 0x40000000, 0x00000001, DP_SQR, ST_FINITEINEXACT,
	"square", dzero, dsnan, dtwo, DP_SQR, ST_ABNAN,
	"add", dhalf, dhalf, done, DP_ADD, ST_INFINITY,
/* an example of where the Weitek chips didn't meet IEEE !!!
 */
	"add", 0x3ff3fdcd, 0xc41c154c, 0xbf71a36a, 0x1b0a4aa0, 0x3ff3ec2a, 0x5a010b01, DP_ADD, ST_FINITEINEXACT,
	"add", 0xbf71a36a, 0x1b0a4aa0, 0x3ff3fdcd, 0xc41c154c, 0x3ff3ec2a, 0x5a010b01, DP_ADD, ST_FINITEINEXACT,
 ...
 */
	"add", done, dmone, dzero, DP_ADD, ST_ZERO,
	"subtract", done, dhalf, dhalf, DP_SUB, ST_INFINITY,
	"multiply", 0x3fe02061, 0x02c794b9, 0xbfdd3b00, 0x0, 0xbfcd7627, 0x3ac3fd84, DP_MUL, ST_FINITEINEXACT,
	"multiply", done, dhalf, dhalf, DP_MUL, ST_INFINITY,
	"multiply", dfour, dhalf, dtwo, DP_MUL, ST_INFINITY,
	"divide", dhalf, done, dhalf, DP_DIV, ST_INFINITY,
	"divide", dhalf, dfour, d1o8, DP_DIV, ST_INFINITY,
	"bw subtract", dhalf, done, dhalf, DP_BSUB, ST_INFINITY,
	"bw divide", done, dhalf, dhalf, DP_BDIV, ST_INFINITY,
	"compare with 0", done, dhalf, done, DP_CMP0, ST_GREATERTHAN,
	"compare with R", done, dhalf, done, DP_CMPR, ST_GREATERTHAN,
	"compare with R", done, dtwo, done, DP_CMPR, ST_LESSTHAN,
	"compare with R", dtwo, done, dtwo, DP_CMPR, ST_GREATERTHAN,
...
struct op1_2_table sdp_table[] =
{
	"convert", 0, 0, seight, deight, SP_CNV, ST_INFINITY,
	"convert", 0, 0, smone, dmone, SP_CNV, ST_INFINITY,
	0, 0, 0, 0, 0, 0, 0, 0
};
struct opx_table
{
...
struct opx_table xp_table[] =
{
	"add", ssnan, dsnan, sone, done, ssnan, dsnan, sone, done, stwo, dtwo, XS_ADD, XD_ADD, ST_INFINITY,
	"add", ssnan, dsnan, stwo, dtwo, ssnan, dsnan, sminnorm, dminnorm, stwo, dtwo, XS_ADD, XD_ADD, ST_FINITEINEXACT,
	"add", ssnan, dsnan, stwo, dtwo, ssnan, dsnan, smone, dmone, sone, done, XS_ADD, XD_ADD, ST_INFINITY,
	"add", ssnan, dsnan, sone, done, ssnan, dsnan, ssnan, dsnan, stwo, dtwo, XS_ADD, XD_ADD, ST_BNAN,
	"add", ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, sone, done, stwo, dtwo, XS_ADD, XD_ADD, ST_ANAN,
	"subtract", ssnan, dsnan, sone, done, ssnan, dsnan, stwo, dtwo, smone, dmone, XS_SUB, XD_SUB, ST_INFINITY,
	"subtract", ssnan, dsnan, sone, done, ssnan, dsnan, sminnorm, dminnorm, sone, done, XS_SUB, XD_SUB, ST_FINITEINEXACT,
	"subtract", ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, sone, done, szero, dzero, XS_SUB, XD_SUB, ST_ANAN,
	"multiply", ssnan, dsnan, sone, done, ssnan, dsnan, sone, done, sone, done, XS_MUL, XD_MUL, ST_INFINITY,
	"multiply", ssnan, dsnan, ssqrt2, 0xbfdd3b00, 0x0, ssnan, dsnan, ssqrt2, 0x3fe02061, 0x02c794b9, 0x3fffffff, 0xbfcd7627, 0x3ac3fd84, XS_MUL, XD_MUL, ST_FINITEINEXACT,
	"multiply", ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, sone, done, smone, dmone, XS_MUL, XD_MUL, ST_ANAN,
	"divide", ssnan, dsnan, smone, dmone, ssnan, dsnan, sone, done, smone, dmone, XS_DIV, XD_DIV, ST_INFINITY,
	"divide", ssnan, dsnan, seight, deight, ssnan, dsnan, stwo, dtwo, sfour, dfour, XS_DIV, XD_DIV, ST_INFINITY,
	"divide", ssnan, dsnan, sone, done, ssnan, dsnan, sonezp1, donezp1, sonezm2, donezm2, XS_DIV, XD_DIV, ST_FINITEINEXACT,
	"divide", ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, stwo, dtwo, sfour, dfour, XS_DIV, XD_DIV, ST_ANAN,
	"bw sub", ssnan, dsnan, stwo, dtwo, ssnan, dsnan, sone, done, smone, dmone, XS_BSUB, XD_BSUB, ST_INFINITY,
	"bw sub", ssnan, dsnan, sminnorm, dminnorm, ssnan, dsnan, stwo, dtwo, stwo, dtwo, XS_BSUB, XD_BSUB, ST_FINITEINEXACT,
	"bw sub", ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, sone, done, smone, dmone, XS_BSUB, XD_BSUB, ST_ANAN,
	"bw div", ssnan, dsnan, stwo, dtwo, ssnan, dsnan, sone, done, shalf, dhalf, XS_BDIV, XD_BDIV, ST_INFINITY,
	"bw div", ssnan, dsnan, sonezp1, donezp1, ssnan, dsnan, sone, done, sonezm2, donezm2, XS_BDIV, XD_BDIV, ST_FINITEINEXACT,
	"bw div", ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, sone, done, shalf, dhalf, XS_BDIV, XD_BDIV, ST_BNAN,
	"sqrt", 0xaaaa1111, dsnan, 0xaaaa2222, dsnan, 0xaaaa3333, dsnan, 0x41c2b852, 0x4038570a, 0x3d70a3d7, 0x409ddfb6, 0x4013bbf6, 0xc5ff5197, XS_SQRT, XD_SQRT, ST_FINITEINEXACT,
	"sqrt", 0xbbbb6666, dsnan, ssnan, dsnan, ssnan, dsnan, szero, dzero, szero, dzero, XS_SQRT, XD_SQRT, ST_ZERO,
	"sqrt", 0xc5c5c5c5, dsnan, ssnan, dsnan, ssnan, dsnan, 0x497c4ee0, 0x412f89db, 0xf77776af, 0x447e25b9, 0x408fc4b7, 0x10efd82d, XS_SQRT, XD_SQRT, ST_FINITEINEXACT,
	"3+(2*d)", ssnan, dsnan, shalf, dhalf, stwo, dtwo, sfour, dfour, sfour, dfour, XS_PIV0, XD_PIV0, ST_INFINITY,
	"3+(2*d)", ssnan, dsnan, shalf, dhalf, ssnan, dsnan, sfour, dfour, sfour, dfour, XS_PIV0, XD_PIV0, ST_BNAN,
	"3+(2*d)", ssnan, dsnan, ssnan, dsnan, stwo, dtwo, sfour, dfour, sfour, dfour, XS_PIV0, XD_PIV0, ST_ANAN,
	"3-(2*d)", ssnan, dsnan, shalf, dhalf, stwo, dtwo, sfour, dfour, szero, dzero, XS_PIV1, XD_PIV1, ST_ZERO,
	"3-(2*d)", ssnan, dsnan, ssnan, dsnan, stwo, dtwo, sfour, dfour, szero, dfour, XS_PIV1, XD_PIV1, ST_ANAN,
	"3-(2*d)", ssnan, dsnan, shalf, dhalf, ssnan, dsnan, sfour, dfour, szero, dzero, XS_PIV1, XD_PIV1, ST_BNAN,
	"-3+(2*d)", ssnan, dsnan, sone, done, shalf, dhalf, shalf, dhalf, szero, dzero, XS_PIV2, XD_PIV2, ST_ZERO,
	"-3+(2*d)", ssnan, dsnan, ssnan, dsnan, shalf, dhalf, shalf, dhalf, szero, dhalf, XS_PIV2, XD_PIV2, ST_ANAN,
	"-3+(2*d)", ssnan, dsnan, sone, done, ssnan, dsnan, shalf, dhalf, szero, dzero, XS_PIV2, XD_PIV2, ST_BNAN,
	"3*(2+d)", ssnan, dsnan, shalf, dhalf, sfour, dfour, shalf, dhalf, sfour, dfour, XS_PIV3, XD_PIV3, ST_INFINITY,
	"3*(2+d)", ssnan, dsnan, shalf, dhalf, ssnan, dfour, shalf, dsnan, sfour, dhalf, XS_PIV3, XD_PIV3, ST_BNAN,
	"3*(2+d)", ssnan, dsnan, ssnan, dsnan, shalf, dhalf, shalf, dhalf, sfour, dfour, XS_PIV3, XD_PIV3, ST_ANAN,
	"3*(2-d)", ssnan, dsnan, shalf, dhalf, smone, dmone, sone, done, shalf, dhalf, XS_PIV4, XD_PIV4, ST_INFINITY,
	"3*(2-d)", ssnan, dsnan, ssnan, dsnan, smone, dmone, sone, done, shalf, dhalf, XS_PIV4, XD_PIV4, ST_ANAN,
	"3*(2-d)", ssnan, dsnan, shalf, dhalf, ssnan, dhalf, sone, dsnan, shalf, done, XS_PIV4, XD_PIV4, ST_BNAN,
	"3*(-2+d)", ssnan, dsnan, shalf, dhalf, seight, deight, sone, done, sfour, dfour, XS_PIV5, XD_PIV5, ST_INFINITY,
	"3*(-2+d)", ssnan, dsnan, ssnan, dsnan, seight, deight, sone, done, sfour, dfour, XS_PIV5, XD_PIV5, ST_ANAN,
	"3*(-2+d)", ssnan, dsnan, shalf, dhalf, ssnan, dsnan, sone, done, sfour, dfour, XS_PIV5, XD_PIV5, ST_BNAN,
	"d+(3*2)", ssnan, dsnan, shalf, dhalf, seight, deight, sfour, dfour, seight, deight, XS_PIV6, XD_PIV6, ST_INFINITY,
	"d+(3*2)", ssnan, dsnan, ssnan, dsnan, seight, deight, sfour, dfour, seight, deight, XS_PIV6, XD_PIV6, ST_ANAN,
	"d+(3*2)", ssnan, dsnan, shalf, dhalf, ssnan, dsnan, sfour, dfour, seight, deight, XS_PIV6, XD_PIV6, ST_BNAN,
	"d-(3*2)", ssnan, dsnan, shalf, dhalf, seight, deight, sfour, dfour, szero, dzero, XS_PIV7, XD_PIV7, ST_ZERO,
	"d-(3*2)", ssnan, dsnan, ssnan, dsnan, seight, deight, sfour, dfour, szero, dzero, XS_PIV7, XD_PIV7, ST_ANAN,
	"d-(3*2)", ssnan, dsnan, shalf, dhalf, ssnan, dsnan, sfour, dfour, szero, dzero, XS_PIV7, XD_PIV7, ST_BNAN,
	"-d+(3*2)", ssnan, dsnan, shalf, dhalf, seight, deight, stwo, dtwo, stwo, dtwo, XS_PIV8, XD_PIV8, ST_INFINITY,
	"-d+(3*2)", ssnan, dsnan, ssnan, dsnan, seight, deight, stwo, dtwo, stwo, dtwo, XS_PIV8, XD_PIV8, ST_ANAN,
	"-d+(3*2)", ssnan, dsnan, shalf, dhalf, ssnan, dsnan, stwo, dtwo, stwo, dtwo, XS_PIV8, XD_PIV8, ST_BNAN,
	"d*(3+2)", ssnan, dsnan, shalf, dhalf, smone, dmone, stwo, dtwo, smone, dmone, XS_PIV9, XD_PIV9, ST_INFINITY,
	"d*(3+2)", ssnan, dsnan, ssnan, dsnan, smone, dmone, stwo, dtwo, smone, dmone, XS_PIV9, XD_PIV9, ST_ANAN,
	"d*(3+2)", ssnan, dsnan, shalf, dhalf, ssnan, dsnan, stwo, dtwo, smone, dmone, XS_PIV9, XD_PIV9, ST_BNAN,
	"d*(3-2)", ssnan, dsnan, shalf, dhalf, sone, done, stwo, dtwo, sone, done, XS_PIVA, XD_PIVA, ST_INFINITY,
	"d*(3-2)", ssnan, dsnan, ssnan, dsnan, sone, done, stwo, dtwo, sone, done, XS_PIVA, XD_PIVA, ST_ANAN,
	"d*(3-2)", ssnan, dsnan, shalf, dhalf, ssnan, dsnan, stwo, dtwo, sone, done, XS_PIVA, XD_PIVA, ST_BNAN,
	0, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, 0, 0, 0
};
struct opl_table
{
...
struct opl_table lp_table[] =
{
	"op2+(r2*op1)", sone, smone, sone, szero, XS_LIN0, ST_ZERO,
	"op2+(r2*op1)", shalf, sfour, smone, sone, XS_LIN0, ST_INFINITY,
	"op2+(r2*op1)", shalf, stwo, sminnorm, sone, XS_LIN0, ST_FINITEINEXACT,
	"op2+(r2*op1)", ssnan, sfour, smone, sone, XS_LIN0, ST_ANAN,
	"op2+(r2*op1)", sone, ssnan, smone, sone, XS_LIN0, ST_BNAN,
	"op2+(r2*op1)", sone, smone, ssnan, sone, XS_LIN0, ST_BNAN,
	"op2-(r2*op1)", sone, smone, sone, stwo, XS_LIN1, ST_INFINITY,
	"op2-(r2*op1)", shalf, sfour, sone, smone, XS_LIN1, ST_INFINITY,
	"op2-(r2*op1)", sone, sone, sminnorm, smone, XS_LIN1, ST_FINITEINEXACT,
	"op2-(r2*op1)", ssnan, sfour, sone, smone, XS_LIN1, ST_ANAN,
	"op2-(r2*op1)", sfour, ssnan, sone, smone, XS_LIN1, ST_BNAN,
	"op2-(r2*op1)", sfour, sone, ssnan, smone, XS_LIN1, ST_BNAN,
	"-op2+(r2*op1)", sone, sone, stwo, smone, XS_LIN2, ST_INFINITY,
	"-op2+(r2*op1)", sfour, sone, sfour, szero, XS_LIN2, ST_ZERO,
	"-op2+(r2*op1)", sone, sone, sminnorm, sone, XS_LIN2, ST_FINITEINEXACT,
	"-op2+(r2*op1)", ssnan, sone, sfour, szero, XS_LIN2, ST_ANAN,
	"-op2+(r2*op1)", sone, ssnan, sfour, szero, XS_LIN2, ST_BNAN,
	"-op2+(r2*op1)", sone, sfour, ssnan, szero, XS_LIN2, ST_BNAN,
	"op2*(r2+op1)", sone, smone, sone, szero, XS_LIN3, ST_ZERO,
	"op2*(r2+op1)", stwo, smone, stwo, stwo, XS_LIN3, ST_INFINITY,
	"op2*(r2+op1)", szero, sonezm1, sonezp1, sone, XS_LIN3, ST_FINITEINEXACT,
	"op2*(r2+op1)", ssnan, smone, stwo, stwo, XS_LIN3, ST_ANAN,
	"op2*(r2+op1)", smone, ssnan, stwo, stwo, XS_LIN3, ST_BNAN,
	"op2*(r2+op1)", smone, stwo, ssnan, stwo, XS_LIN3, ST_BNAN,
	"op2*(r2-op1)", sone, smone, sone, stwo, XS_LIN4, ST_INFINITY,
	"op2*(r2-op1)", shalf, sone, smone, shalf, XS_LIN4, ST_INFINITY,
	"op2*(r2-op1)", sonezm1, szero, sonezp1, sone, XS_LIN4, ST_FINITEINEXACT,
	"op2*(r2-op1)", ssnan, sone, smone, shalf, XS_LIN4, ST_ANAN,
	"op2*(r2-op1)", sone, ssnan, smone, shalf, XS_LIN4, ST_BNAN,
	"op2*(r2-op1)", sone, smone, ssnan, shalf, XS_LIN4, ST_BNAN,
	"op2*(-r2+op1)", sone, stwo, stwo, stwo, XS_LIN5, ST_INFINITY,
	"op2*(-r2+op1)", sfour, seight, shalf, stwo, XS_LIN5, ST_INFINITY,
	"op2*(-r2+op1)", szero, sonezm1, sonezp1, sone, XS_LIN5, ST_FINITEINEXACT,
	"op2*(-r2+op1)", ssnan, seight, shalf, stwo, XS_LIN5, ST_ANAN,
	"op2*(-r2+op1)", seight, ssnan, shalf, stwo, XS_LIN5, ST_BNAN,
	"op2*(-r2+op1)", seight, shalf, ssnan, stwo, XS_LIN5, ST_BNAN,
	0, ssnan, ssnan, ssnan, ssnan, 0, 0
};
struct opc_table
{
...
struct opc_table cp_table[] =
{
	"sqrt", 0x41c2b852, 0x4038570a, 0x3d70a3d7, ssnan, dsnan, ssnan, dsnan, 0x409ddfb6, 0x4013bbf6, 0xc5ff5197, CS_SQRT, CD_SQRT, ST_FINITEINEXACT,
	"sqrt", szero, dzero, ssnan, dsnan, ssnan, dsnan, szero, dzero, CS_SQRT, CD_SQRT, ST_ZERO,
	"sqrt", 0x497c4ee0, 0x412f89db, 0xf77776af, ssnan, dsnan, ssnan, dsnan, 0x447e25b9, 0x408fc4b7, 0x10efd82d, CS_SQRT, CD_SQRT, ST_FINITEINEXACT,
	"sin", szero, dzero, ssnan, dsnan, ssnan, dsnan, szero, dzero, CS_SIN, CD_SIN, ST_FINITEINEXACT,
	"sin", smhalf, dmhalf, ssnan, dsnan, ssnan, dsnan, 0xbef57744, 0xbfdeaee8, 0x744b05f0, CS_SIN, CD_SIN, ST_FINITEINEXACT,
	"sin", shalf, dhalf, ssnan, dsnan, ssnan, dsnan, 0x3ef57744, 0x3fdeaee8, 0x744b05f0, CS_SIN, CD_SIN, ST_FINITEINEXACT,
	"sin", sone, done, ssnan, dsnan, ssnan, dsnan, 0x3f576aa4, 0x3feaed54, 0x8f090cee, CS_SIN, CD_SIN, ST_FINITEINEXACT,
	"sin", smone, dmone, ssnan, dsnan, ssnan, dsnan, 0xbf576aa4, 0xbfeaed54, 0x8f090cee, CS_SIN, CD_SIN, ST_FINITEINEXACT,
	...
	"sin", 0x41000000, 0x40200000, 0x00000000, ssnan, dsnan, ssnan, dsnan, 0x3f7d4695, 0x3fefa8d2, 0xa028cf7b, CS_SIN, CD_SIN, ST_FINITEINEXACT,
	"sin", 0xc1000000, 0xc0200000, 0x00000000, ssnan, dsnan, ssnan, dsnan, 0xbf7d4695, 0xbfefa8d2, 0xa028cf7b, CS_SIN, CD_SIN, ST_FINITEINEXACT,
	"sin", 0x42000000, 0x40400000, 0x00000000, ssnan, dsnan, ssnan, dsnan, 0x3f0d2a4d, 0x3fe1a549, 0x91426566, CS_SIN, CD_SIN, ST_FINITEINEXACT,
	"sin", 0x49c90fd8, 0x413921fa, 0xffffffff, ssnan, dsnan, ssnan, dsnan, 0xbea58173, 0xbfd4b02e, 0x5c25aedc, CS_SIN, CD_SIN, ST_FINITEINEXACT,
	/*"sin", 0x49c90fd9, 0x413921fb, 0x00000000, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_SIN, CD_SIN, ST_OUTOFBOUNDS,
	"sin", ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_SIN, CD_SIN, ST_OUTOFBOUNDS,
	"sin", sqnan, dqnan, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_SIN, CD_SIN, ST_OUTOFBOUNDS,
	"sin", smaxnorm, dmaxnorm, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_SIN, CD_SIN, ST_OUTOFBOUNDS,
*/
	"cos", szero, dzero, ssnan, dsnan, ssnan, dsnan, sone, done, CS_COS, CD_COS, ST_FINITEINEXACT,
	"cos", smhalf, dmhalf, ssnan, dsnan, ssnan, dsnan, 0x3f60a940, 0x3fec1528, 0x065b7d50, CS_COS, CD_COS, ST_FINITEINEXACT,
	"cos", shalf, dhalf, ssnan, dsnan, ssnan, dsnan, 0x3f60a940, 0x3fec1528, 0x065b7d50, CS_COS, CD_COS, ST_FINITEINEXACT,
	"cos", smone, dmone, ssnan, dsnan, ssnan, dsnan, 0x3f0a5140, 0x3fe14a28, 0x0fb5068c, CS_COS, CD_COS, ST_FINITEINEXACT,
	"cos", sone, done, ssnan, dsnan, ssnan, dsnan, 0x3f0a5140, 0x3fe14a28, 0x0fb5068c, CS_COS, CD_COS, ST_FINITEINEXACT,
...
/*	"cos", 0x49c90fdc, 0x413921fb, 0x54442d19, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_COS, CD_COS, ST_OUTOFBOUNDS,
	...
	"cos", smaxnorm, dmaxnorm, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_COS, CD_COS, ST_OUTOFBOUNDS,
*/
	"atan", szero, dzero, ssnan, dsnan, ssnan, dsnan, szero, dzero, CS_ATAN, CD_ATAN, ST_FINITEINEXACT,
	"atan", c_stwopm26, c_dtwopm54, ssnan, dsnan, ssnan, dsnan, c_stwopm26, c_dtwopm54, CS_ATAN, CD_ATAN, ST_FINITEINEXACT,
	"atan", sone, done, ssnan, dsnan, ssnan, dsnan, 0x3f490fdb, 0x3fe921fb, 0x54442d18, CS_ATAN, CD_ATAN, ST_FINITEINEXACT,
	"atan", smone, dmone, ssnan, dsnan, ssnan, dsnan, 0xbf490fdb, 0xbfe921fb, 0x54442d18, CS_ATAN, CD_ATAN, ST_FINITEINEXACT,
	"atan", shalf, dhalf, ssnan, dsnan, ssnan, dsnan, 0x3eed6338, 0x3fddac67, 0x0561bb4f, CS_ATAN, CD_ATAN, ST_FINITEINEXACT,
...
/*  13/16 */
	...
	"atan", sinf, dinf, ssnan, dsnan, ssnan, dsnan, 0x3fc90fdb, 0x3ff921fb, 0x54442d18, CS_ATAN, CD_ATAN, ST_FINITEINEXACT,
	/*"atan", ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_ATAN, CD_ATAN, ST_OUTOFBOUNDS,*/
	"ln", sone, done, ssnan, dsnan, ssnan, dsnan, szero, dzero, CS_LN, CD_LN, ST_FINITEINEXACT,
	"ln", stwo, dtwo, ssnan, dsnan, ssnan, dsnan, 0x3f317218, 0x3fe62e42, 0xfefa39ef, CS_LN, CD_LN, ST_FINITEINEXACT,
	"ln", sthree, dthree, ssnan, dsnan, ssnan, dsnan, 0x3f8c9f54, 0x3ff193ea, 0x7aad030a, CS_LN, CD_LN, ST_FINITEINEXACT,
	"ln", sminnorm, dminnorm, ssnan, dsnan, ssnan, dsnan, 0xc2aeac50, 0xc086232b, 0xdd7abcd2, CS_LN, CD_LN, ST_FINITEINEXACT,
	/*"ln", smaxsub, dmaxsub, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_LN, CD_LN, ST_OUTOFBOUNDS,*/
	...
	/*"ln", 0x7f000000, 0x7fe00000, 0x00000000, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_LN, CD_LN, ST_OUTOFBOUNDS,*/
	/*"ln", ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_LN, CD_LN, ST_OUTOFBOUNDS,*/
	"ln1", szero, dzero, ssnan, dsnan, ssnan, dsnan, szero, dzero, CS_LN1, CD_LN1, ST_FINITEINEXACT,
	"ln1", c_stwopm26, c_dtwopm54, ssnan, dsnan, ssnan, dsnan, c_stwopm26, c_dtwopm54, CS_LN1, CD_LN1, ST_FINITEINEXACT,
	"ln1", 0xbf400000, 0xbfe80000, 0x00000000, ssnan, dsnan, ssnan, dsnan, 0xbfb17218, 0xbff62e42, 0xfefa39ef, CS_LN1, CD_LN1, ST_FINITEINEXACT,
	"ln1", 0xbe800000, 0xbfd00000, 0x00000000, ssnan, dsnan, ssnan, dsnan, 0xbe934b11, 0xbfd26962, 0x1134db92, CS_LN1, CD_LN1, ST_FINITEINEXACT,
	"ln1", 0xbf000000, 0xbfe00000, 0x00000000, ssnan, dsnan, ssnan, dsnan, 0xbf317218, 0xbfe62e42, 0xfefa39ef, CS_LN1, CD_LN1, ST_FINITEINEXACT,
	...
	"ln1", c_smaxln, c_dmaxln, ssnan, dsnan, ssnan, dsnan, 0x42b00f33, 0x408628b7, 0x5e3a6b61, CS_LN1, CD_LN1, ST_FINITEINEXACT,
	/*"ln1", 0x7f000000, 0x7fe00000, 0x00000000, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_LN1, CD_LN1, ST_OUTOFBOUNDS,*/
	"exp", szero, dzero, ssnan, dsnan, ssnan, dsnan, sone, done, CS_EXP, CD_EXP, ST_FINITEINEXACT,
	"exp", c_stwopm26, c_dtwopm54, ssnan, dsnan, ssnan, dsnan, sone, done, CS_EXP, CD_EXP, ST_FINITEINEXACT,
	"exp", sone, done, ssnan, dsnan, ssnan, dsnan, 0x402df854, 0x4005bf0a, 0x8b14576a, CS_EXP, CD_EXP, ST_FINITEINEXACT,
	"exp", stwo, dtwo, ssnan, dsnan, ssnan, dsnan, 0x40ec7326, 0x401d8e64, 0xb8d4ddae, CS_EXP, CD_EXP, ST_FINITEINEXACT,
	"exp", c_s87, c_d708, ssnan, dsnan, ssnan, dsnan, 0x7e36d809, 0x7fc586f6, 0xbf260cf1, CS_EXP, CD_EXP, ST_FINITEINEXACT,
	...
	"exp", 0xc2ae0001, 0xc0862000, 0x00000001, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_EXP, CD_EXP, ST_OUTOFBOUNDS,
	"exp", ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_EXP, CD_EXP, ST_OUTOFBOUNDS,*/
	"exp1", szero, dzero, ssnan, dsnan, ssnan, dsnan, szero, dzero, CS_EXP1, CD_EXP1, ST_FINITEINEXACT,
	"exp1", c_stwopm26, c_dtwopm54, ssnan, dsnan, ssnan, dsnan, c_stwopm26, c_dtwopm54, CS_EXP1, CD_EXP1, ST_FINITEINEXACT,
	"exp1", 0x42800000, 0x40500000, 0x00000000, ssnan, dsnan, ssnan, dsnan, 0x6da12cc1, 0x45b42598, 0x2cf597cd, CS_EXP1, CD_EXP1, ST_FINITEINEXACT,
	"exp1", smone, dmone, ssnan, dsnan, ssnan, dsnan, 0xbf21d2a7, 0xbfe43a54, 0xe4e98864, CS_EXP1, CD_EXP1, ST_FINITEINEXACT,
	"exp1", sone, done, ssnan, dsnan, ssnan, dsnan, 0x3fdbf0a9, 0x3ffb7e15, 0x1628aed2, CS_EXP1, CD_EXP1, ST_FINITEINEXACT,
	"exp1", stwo, dtwo, ssnan, dsnan, ssnan, dsnan, 0x40cc7326, 0x40198e64, 0xb8d4ddae, CS_EXP1, CD_EXP1, ST_FINITEINEXACT,
	"exp1", 0xc0000000, 0xc0000000, 0x00000000, ssnan, dsnan, ssnan, dsnan, 0xbf5d5aab, 0xbfebab55, 0x57101f8d, CS_EXP1, CD_EXP1, ST_FINITEINEXACT,
	"exp1", c_s87, c_d708, ssnan, dsnan, ssnan, dsnan, 0x7e36d809, 0x7fc586f6, 0xbf260cf1, CS_EXP1, CD_EXP1, ST_FINITEINEXACT,
	/*"exp1", 0x42ae0001, 0x40862000, 0x00000001, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_EXP1, CD_EXP1, ST_OUTOFBOUNDS,
	...
	"copy", 0xaaaaaaaa, 0x55555555, 0xaaaaaaaa, ssnan, dsnan, ssnan, dsnan, 0xaaaaaaaa, 0x55555555, 0xaaaaaaaa, CS_CPY, CD_CPY, ST_DONTCARE,
	"copy", 0x55555555, 0xaaaaaaaa, 0x55555555, ssnan, dsnan, ssnan, dsnan, 0x55555555, 0xaaaaaaaa, 0x55555555, CS_CPY, CD_CPY, ST_DONTCARE,
	"3+2*4", smone, dmone, sone, done, stwo, dtwo, smone, dmone, CS_PIV1, CD_PIV1, ST_INFINITY,
	"3+2*4", smone, dmone, sminnorm, dminnorm, sone, done, smone, dmone, CS_PIV1, CD_PIV1, ST_FINITEINEXACT,
	"3+2*4", ssnan, dsnan, sone, done, stwo, dtwo, smone, dmone, CS_PIV1, CD_PIV1, ST_ANAN,
	"3+2*4", sone, done, ssnan, dsnan, stwo, dtwo, smone, dmone, CS_PIV1, CD_PIV1, ST_BNAN,
	"3+2*4", sone, done, stwo, dtwo, ssnan, dsnan, smone, dmone, CS_PIV1, CD_PIV1, ST_BNAN,
	"3-2*4", smone, dmone, stwo, dtwo, stwo, dtwo, sfour, dfour, CS_PIV2, CD_PIV2, ST_INFINITY,
	"3-2*4", smone, dmone, sminnorm, dminnorm, stwo, dtwo, stwo, dtwo, CS_PIV2, CD_PIV2, ST_FINITEINEXACT,
	"3-2*4", ssnan, dsnan, stwo, dtwo, stwo, dtwo, sfour, dfour, CS_PIV2, CD_PIV2, ST_ANAN,
	"3-2*4", stwo, dtwo, ssnan, dsnan, stwo, dtwo, sfour, dfour, CS_PIV2, CD_PIV2, ST_BNAN,
	"3-2*4", stwo, dtwo, stwo, dtwo, ssnan, dsnan, sfour, dfour, CS_PIV2, CD_PIV2, ST_BNAN,
	"-3+2*4", sone, done, stwo, dtwo, sfour, dfour, stwo, dtwo, CS_PIV3, CD_PIV3, ST_INFINITY,
	"-3+2*4", sone, done, sminnorm, dminnorm, sfour, dfour, sfour, dfour, CS_PIV3, CD_PIV3, ST_FINITEINEXACT,
	"-3+2*4", ssnan, dsnan, stwo, dtwo, sfour, dfour, stwo, dtwo, CS_PIV3, CD_PIV3, ST_ANAN,
	"-3+2*4", stwo, dtwo, ssnan, dsnan, sfour, dfour, stwo, dtwo, CS_PIV3, CD_PIV3, ST_BNAN,
	"-3+2*4", stwo, dtwo, sfour, dfour, ssnan, dsnan, stwo, dtwo, CS_PIV3, CD_PIV3, ST_BNAN,
	"3*2+4", smone, dmone, smone, dmone, shalf, dhalf, shalf, dhalf, CS_PIV4, CD_PIV4, ST_INFINITY,
	"3*2+4", sonezp1, donezp1, sonezm1, donezm1, szero, dzero, sone, done, CS_PIV4, CD_PIV4, ST_FINITEINEXACT,
	"3*2+4", ssnan, dsnan, smone, dmone, shalf, dhalf, shalf, dhalf, CS_PIV4, CD_PIV4, ST_ANAN,
	"3*2+4", smone, dmone, ssnan, dsnan, shalf, dhalf, shalf, dhalf, CS_PIV4, CD_PIV4, ST_BNAN,
	"3*2+4", smone, dmone, shalf, dhalf, ssnan, dsnan, shalf, dhalf, CS_PIV4, CD_PIV4, ST_BNAN,
	"3*2-4", sone, done, sone, done, shalf, dhalf, shalf, dhalf, CS_PIV5, CD_PIV5, ST_INFINITY,
	"3*2-4", sonezp1, donezp1, sonezm1, donezm1, szero, dzero, sone, done, CS_PIV5, CD_PIV5, ST_FINITEINEXACT,
	"3*2-4", ssnan, dsnan, sone, done, shalf, dhalf, shalf, dhalf, CS_PIV5, CD_PIV5, ST_ANAN,
	"3*2-4", sone, done, ssnan, dsnan, shalf, dhalf, shalf, dhalf, CS_PIV5, CD_PIV5, ST_BNAN,
	"3*2-4", sone, done, shalf, dhalf, ssnan, dsnan, shalf, dhalf, CS_PIV5, CD_PIV5, ST_BNAN,
	"3*-2+4", sone, done, smone, dmone, shalf, dhalf, shalf, dhalf, CS_PIV6, CD_PIV6, ST_INFINITY,
	"3*-2+4", szero, dzero, sonezm1, donezm1, sonezp1, donezp1, sone, done, CS_PIV6, CD_PIV6, ST_FINITEINEXACT,
	"3*-2+4", ssnan, dsnan, smone, dmone, shalf, dhalf, shalf, dhalf, CS_PIV6, CD_PIV6, ST_ANAN,
	"3*-2+4", smone, dmone, ssnan, dsnan, shalf, dhalf, shalf, dhalf, CS_PIV6, CD_PIV6, ST_BNAN,
	"3*-2+4", smone, dmone, shalf, dhalf, ssnan, dsnan, shalf, dhalf, CS_PIV6, CD_PIV6, ST_BNAN,
	"ALU op = 00", sone, done, smone, dmone, ssnan, dsnan, stwo, dtwo, CS_ALU00, CD_ALU00, ST_INFINITY,
	"ALU op = 01", smone, dmone, sone, done, ssnan, dsnan, stwo, dtwo, CS_ALU01, CD_ALU01, ST_INFINITY,
	"ALU op = 02", smone, dmone, sone, done, ssnan, dsnan, szero, dzero, CS_ALU02, CD_ALU02, ST_ZERO,
	"ALU op = 03", seight, deight, sfour, dfour, ssnan, dsnan, stwo, dtwo, CS_ALU03, CD_ALU03, ST_INFINITY,
	"ALU op = 04", smone, dmone, ssnan, dsnan, ssnan, dsnan, sone, done, CS_ALU04, CD_ALU04, ST_INFINITY,
/* have to figure out how to do wrapped op's!!
	"ALU op = 07", seight, deight, sfour, dfour, ssnan, dsnan, stwo, dtwo, CS_ALU07, CD_ALU07, ST_INFINITY,
 */
	0, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, 0, 0, 0
};
struct opc_table sincosp_table[] =
{
/*	"sincos", 0x49c90fdc, 0x413921fb, 0x54442d19, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_SINCOS, CD_SINCOS, ST_OUTOFBOUNDS,
	"sincos", ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_SINCOS, CD_SINCOS, ST_OUTOFBOUNDS,
	"sincos", sqnan, dqnan, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_SINCOS, CD_SINCOS, ST_OUTOFBOUNDS,
	...
	"sincos", smaxnorm, dmaxnorm, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, CS_SINCOS, CD_SINCOS, ST_OUTOFBOUNDS, */
	"sincos", szero, dzero, ssnan, dsnan, sone, done, szero, dzero, CS_SINCOS, CD_SINCOS, ST_FINITEINEXACT,
	"sincos", smhalf, dmhalf, ssnan, dsnan, 0x3f60a940, 0x3fec1528, 0x065b7d50, 0xbef57744, 0xbfdeaee8, 0x744b05f0, CS_SINCOS, CD_SINCOS, ST_FINITEINEXACT,
	"sincos", shalf, dhalf, ssnan, dsnan, 0x3f60a940, 0x3fec1528, 0x065b7d50, 0x3ef57744, 0x3fdeaee8, 0x744b05f0, CS_SINCOS, CD_SINCOS, ST_FINITEINEXACT,
	"sincos", sone, done, ssnan, dsnan, 0x3f0a5140, 0x3fe14a28, 0x0fb5068c, 0x3f576aa4, 0x3feaed54, 0x8f090cee, CS_SINCOS, CD_SINCOS, ST_FINITEINEXACT,
	"sincos", smone, dmone, ssnan, dsnan, 0x3f0a5140, 0x3fe14a28, 0x0fb5068c, 0xbf576aa4, 0xbfeaed54, 0x8f090cee, CS_SINCOS, CD_SINCOS, ST_FINITEINEXACT,
	...
	"sincos", 0x41000000, 0x40200000, 0x00000000, ssnan, dsnan, 0xbe14fdf6, 0xbfc29fbe, 0xbf632f94, 0x3f7d4695, 0x3fefa8d2, 0xa028cf7b, CS_SINCOS, CD_SINCOS, ST_FINITEINEXACT,
	"sincos", 0xc1000000, 0xc0200000, 0x00000000, ssnan, dsnan, 0xbe14fdf6, 0xbfc29fbe, 0xbf632f94, 0xbf7d4695, 0xbfefa8d2, 0xa028cf7b, CS_SINCOS, CD_SINCOS, ST_FINITEINEXACT,
	"sincos", 0x42000000, 0x40400000, 0x00000000, ssnan, dsnan, 0x3f558faa, 0x3feab1f5, 0x305de8e5, 0x3f0d2a4d, 0x3fe1a549, 0x91426566, CS_SINCOS, CD_SINCOS, ST_FINITEINEXACT,
	"sincos", 0x49c90fd8, 0x413921fa, 0xffffffff, ssnan, dsnan, 0x3f724189, 0x3fee4831, 0x25700ac9, 0xbea58173, 0xbfd4b02e, 0x5c25aedc, CS_SINCOS, CD_SINCOS, ST_FINITEINEXACT,
	0, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, ssnan, dsnan, 0, 0, 0
};
struct opm_table
{
...
struct opm_table mp_table[] =
{
	...
	"3x3 Transpose", &start1[0][0], &matrix_sp5[0][0], &matrix_dp5[0][0], CS_3TRN, CD_3TRN, ST_DONTCARE,
	"4x4 Transpose", &start1[0][0], &matrix_sp6[0][0], &matrix_dp6[0][0], CS_4TRN, CD_4TRN, ST_DONTCARE,
	"2x2 Dot", &start_dot_sp[0][0], &start_dot_sp1[0][0], 0, CS_2DOT, 0, ST_INFINITY,
	"3x3 Dot", &start_dot_sp[0][0], &start_dot_sp2[0][0], 0, CS_3DOT, 0, ST_INFINITY,
	"4x4 Dot", &start_dot_sp[0][0], &start_dot_sp3[0][0], 0, CS_4DOT, 0, ST_INFINITY,
	"2x2 Dot", &start_dot_dp[0][0], 0, &start_dot_dp1[0][0], 0, CD_2DOT, ST_INFINITY,
	"3x3 Dot", &start_dot_dp[0][0], 0, &start_dot_dp2[0][0], 0, CD_3DOT, ST_INFINITY,
	"4x4 Dot", &start_dot_dp[0][0], 0, &start_dot_dp3[0][0], 0, CD_4DOT, ST_INFINITY,
	0, 0, 0, 0, 0, 0, 0
};
...
int pass_count = 0;
	...
	if(fpa->fp_pipe_status & FPA_FIRST_V_ACT)
	{
 	...
 	/* Determine type of FPA installed */
        fpa_type = (enum fpa_type) (0x000e & fpa->fp_imask);
...
long stat;
	...
	for(fpa->fp_imask &= ~FPA_INEXACT, j = 0; j < 2; j++ , fpa->fp_imask |= FPA_INEXACT)
	{
		for(i = 0; spp_table[i].name; i++)
		{
			if(verbose_flag)
				printf("  Testing single precision %s\n", spp_table[i].name);
			wrt_fp_op(PUT_REG_SP, 0, spp_table[i].r1);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(spp_table[i].op, 0, spp_table[i].data);
			stat = ck_stat(spp_table[i].status);
			if(stat != spp_table[i].status)
			{
				printf("Incorrect Status for %s, Expected: %01lx, Returned: %01lx\n", spp_table[i].name, spp_table[i].status, stat);
				if(stop_on_error)
					exit(-1);
			}
			rd_fp_op(GET_REG_SP, 0, &temp);
			...
			{
				if(temp != spp_table[i].result)
				{
					printf("SP Comparison Failure: %s\n", spp_table[i].name);
					printf("    Expected: %08lx, Returned: %08lx\n", spp_table[i].result, temp);
					if(stop_on_error)
						exit(-1);
				}
			}
...
long stat;
	...
	for(fpa->fp_imask &= ~FPA_INEXACT, j = 0; j < 2; j++ , fpa->fp_imask |= FPA_INEXACT)
	{
		for(i = 0; dpp_table[i].name; i++)
		{
			if(verbose_flag)
				printf("  Testing double precision %s\n", dpp_table[i].name);
			wrt_fp_op(PUT_REG_MS, 0, dpp_table[i].r1_ms);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_LS, 0, dpp_table[i].r1_ls);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(dpp_table[i].op1, 0, dpp_table[i].data_ms);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(dpp_table[i].op2, 0, dpp_table[i].data_ls);
			stat = ck_stat(dpp_table[i].status);
			if(stat != dpp_table[i].status)
			{
				printf("Incorrect Status for %s, Expected: %01lx, Returned: %01lx\n", dpp_table[i].name, dpp_table[i].status, stat);
				if(stop_on_error)
					exit(-1);
			}
			rd_fp_op(GET_REG_MS, 0, &temp1);
			...
			if((stat > ST_FINITEINEXACT) || ((stat == ST_FINITEINEXACT) && (fpa->fp_imask & FPA_INEXACT)))
			{
				if((temp1 != dpp_table[i].r1_ms) || (temp2 != dpp_table[i].r1_ls))
				{
got_error++;
					printf("DP Inexact Restore Failure: %s\n", dpp_table[i].name);
					printf("    Expected: %08lx(ms), %08lx(ls)\n", dpp_table[i].r1_ms, dpp_table[i].r1_ls);
					printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
					if(stop_on_error)
						exit(-1);
				}
			...
			{
				if((temp1 != dpp_table[i].result_ms) || (temp2 != dpp_table[i].result_ls))
				{
got_error++;
					printf("DP Comparison Failure: %s\n", dpp_table[i].name);
					printf("    Expected: %08lx(ms), %08lx(ls)\n", dpp_table[i].result_ms, dpp_table[i].result_ls);
					printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
					if(stop_on_error)
						exit(-1);
				}
...
long stat;
	...
	if(!quiet_flag)
		printf("Starting  Test of Single Precision Convert Operations\n");
	init_fpa();
	for(i = 0; sdp_table[i].name; i++)
	{
		if(verbose_flag)
			printf("  Testing single precision %s\n", sdp_table[i].name);
		wrt_fp_op(PUT_REG_MS, 0, sdp_table[i].r1_ms);
		ck_stat(ST_DONTCARE);
		wrt_fp_op(PUT_REG_LS, 0, sdp_table[i].r1_ls);
		ck_stat(ST_DONTCARE);
		wrt_fp_op(sdp_table[i].op, 0, sdp_table[i].data);
		stat = ck_stat(sdp_table[i].status);
		if(stat != sdp_table[i].status)
		{
			printf("Incorrect Status for %s, Expected: %01lx, Returned: %01lx\n", sdp_table[i].name, sdp_table[i].status, stat);
			if(stop_on_error)
				exit(-1);
		}
		rd_fp_op(GET_REG_MS, 0, &temp1);
		rd_fp_op(GET_REG_LS, 0, &temp2);
		if((temp1 != sdp_table[i].result_ms) || (temp2 != sdp_table[i].result_ls))
		{
			printf("SP Comparison Failure: %s\n", sdp_table[i].name);
			printf("    Expected: %08lx(ms), %08lx(ls)\n", sdp_table[i].result_ms, sdp_table[i].result_ls);
			printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
			if(stop_on_error)
				exit(-1);
		}
...
long stat;
	...
	for(fpa->fp_imask &= ~FPA_INEXACT, j = 0; j < 2; j++ , fpa->fp_imask |= FPA_INEXACT)
	{
		for(i = 0; xp_table[i].name; i++)
		{
			if(xp_table[i].op_sp == 0)
				continue;
			if(verbose_flag)
				printf("  Testing single precision %s\n", xp_table[i].name);
			wrt_fp_op(PUT_REG_MS, 1, xp_table[i].r1_sp);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_LS, 1, 0x55555555);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_MS, 2, xp_table[i].r2_sp);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_LS, 2, 0xaaaaaaaa);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_MS, 3, xp_table[i].r3_sp);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_LS, 3, 0xaaaaaaaa);
			ck_stat(ST_DONTCARE);
			x_wrt_fp_op(xp_table[i].op_sp, 1, 2, 3, xp_table[i].data_sp, 0xeeeeeeee);
			stat = ck_stat(xp_table[i].status);
			if(stat != xp_table[i].status)
			{
				printf("Incorrect Status for %s, Expected: %01lx, Returned: %01lx\n", xp_table[i].name, xp_table[i].status, stat);
				if(stop_on_error)
					exit(-1);
			}
			rd_fp_op(GET_REG_MS, 1, &temp1);
			...
			if((stat > ST_FINITEINEXACT) || ((stat == ST_FINITEINEXACT) && (fpa->fp_imask & FPA_INEXACT)))
			{
				if((temp1 != xp_table[i].r1_sp) || (temp2 != 0x55555555))
				{
					printf("SP Extended Comparison Failure: %s\n", xp_table[i].name);
					printf("    Expected: %08lx(ms), %08lx(ls)\n", xp_table[i].r1_sp, 0x55555555);
					printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
					if(stop_on_error)
						exit(-1);
				}
			...
			{
				if((temp1 != xp_table[i].result_sp) || (temp2 != 0x55555555))
				{
					printf("SP Extended (NO IMASK) Comparison Failure: %s\n", xp_table[i].name);
					printf("    Expected: %08lx(ms), %08lx(ls)\n", xp_table[i].result_sp, 0x55555555);
					printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
					if(stop_on_error)
						exit(-1);
				}
	...
	for(fpa->fp_imask &= ~FPA_INEXACT, j = 0; j < 2; j++ , fpa->fp_imask |= FPA_INEXACT)
	{
		for(i = 0; xp_table[i].name; i++)
		{
			if(xp_table[i].op_dp == 0)
				continue;
			if(verbose_flag)
				printf("  Testing double precision %s\n", xp_table[i].name);
			wrt_fp_op(PUT_REG_MS, 1, xp_table[i].r1_ms);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_LS, 1, xp_table[i].r1_ls);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_MS, 2, xp_table[i].r2_ms);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_LS, 2, xp_table[i].r2_ls);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_MS, 3, xp_table[i].r3_ms);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_LS, 3, xp_table[i].r3_ls);
			ck_stat(ST_DONTCARE);
			x_wrt_fp_op(xp_table[i].op_dp, 1, 2, 3, xp_table[i].data_ms, xp_table[i].data_ls);
			stat = ck_stat(xp_table[i].status);
			if(stat != xp_table[i].status)
			{
				printf("Incorrect Status for %s, Expected: %01lx, Returned: %01lx\n", xp_table[i].name, xp_table[i].status, stat);
			...
			if((stat > ST_FINITEINEXACT) || ((stat == ST_FINITEINEXACT) && (fpa->fp_imask & FPA_INEXACT)))
			{
				if((temp1 != xp_table[i].r1_ms) || (temp2 != xp_table[i].r1_ls))
				{
					printf("DP Comparison Failure: %s\n", xp_table[i].name);
					printf("    Expected: %08lx(ms), %08lx(ls)\n", xp_table[i].r1_ms, xp_table[i].r1_ls);
					printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
					if(stop_on_error)
						exit(-1);
				}
			...
			{
				if((temp1 != xp_table[i].result_ms) || (temp2 != xp_table[i].result_ls))
				{
					printf("DP Comparison Failure: %s\n", xp_table[i].name);
					printf("    Expected: %08lx(ms), %08lx(ls)\n", xp_table[i].result_ms, xp_table[i].result_ls);
					printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
					if(stop_on_error)
						exit(-1);
				}
	...
	for(fpa->fp_imask &= ~FPA_INEXACT, j = 0; j < 2; j++ , fpa->fp_imask |= FPA_INEXACT)
	{
		for(i = 0; lp_table[i].name; i++)
		{
			if(lp_table[i].op_sp == 0)
				continue;
			if(verbose_flag)
				printf("  Testing linpack %s\n", lp_table[i].name);
			wrt_fp_op(PUT_REG_MS, 1, 0x33333333);
			...
			wrt_fp_op(PUT_REG_LS, 1, 0x44444444);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_MS, 2, lp_table[i].r2_sp);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_LS, 2, 0xaaaaaaaa);
			ck_stat(ST_DONTCARE);
			wrt_fp_op(PUT_REG_MS, 3, 0x55555555);
			...
			wrt_fp_op(PUT_REG_LS, 3, 0xaaaaaaaa);
			ck_stat(ST_DONTCARE);
			x_wrt_fp_op(lp_table[i].op_sp, 1, 2, 3, lp_table[i].data1_sp, lp_table[i].data2_sp);
			stat = ck_stat(lp_table[i].status);
			if(stat != lp_table[i].status)
			{
				printf("Incorrect Status for %s, Expected: %01lx, Returned: %01lx\n", lp_table[i].name, lp_table[i].status, stat);
				if(stop_on_error)
					exit(-1);
			}
			rd_fp_op(GET_REG_MS, 1, &temp1);
			...
			{
				if((temp1 != lp_table[i].result_sp) || (temp2 != 0x44444444))
				{
					printf("SP Comparison Failure: %s\n", lp_table[i].name);
					printf("    Expected: %08lx(ms), %08lx(ls)\n", lp_table[i].result_sp, 0x44444444);
					printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
					if(stop_on_error)
						exit(-1);
				}
...
long stat;
	...
	for(k = 0; k < 2; k++)
	{
		for(fpa->fp_imask &= ~FPA_INEXACT, j = 0; j < 2; j++ , fpa->fp_imask |= FPA_INEXACT)
		{
			if(verbose_flag)
				printf("IMASK   is: %08x\n", (fpa->fp_imask & 0x01));
			for(i = 0; cp_table[i].name; i++)
			{
				if(cp_table[i].op_sp == 0)
					continue;
				if(verbose_flag)
					printf("  Testing single precision %s\n", cp_table[i].name);
				wrt_fp_op(PUT_REG_MS, 1, 0xbbbbbbbb);
				...
				wrt_fp_op(PUT_REG_LS, 1, 0x66666666);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 2, cp_table[i].r2_sp);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 2, 0x66666666);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 3, cp_table[i].r3_sp);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 3, 0xaaaaaaaa);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 4, cp_table[i].r4_sp);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 4, 0xaaaaaaaa);
				ck_stat(ST_DONTCARE);
					/* for inexact restore, use the same reg for
					   operand and result */
				c_wrt_fp_op(cp_table[i].op_sp, 1+k, 2, 3, 4);
				stat = ck_stat(cp_table[i].status);
				if(stat != cp_table[i].status)
				{
					printf("Incorrect Status for %s, Expected: %01lx, Returned: %01lx\n", cp_table[i].name, cp_table[i].status, stat);
					if(stop_on_error)
						exit(-1);
				}
				rd_fp_op(GET_REG_MS, 1+k, &temp1);
				...
				if((stat > ST_FINITEINEXACT) || ((stat == ST_FINITEINEXACT) && (fpa->fp_imask & FPA_INEXACT)))
				{
					if((temp1 != (k?cp_table[i].r2_sp:0xbbbbbbbb)) || (temp2 != 0x66666666))
					{
						printf("SP Command Register Comparison Failure: %s\n", cp_table[i].name);
						printf("    Expected: %08lx(ms), %08lx(ls)\n", (k?cp_table[i].r2_sp:0xbbbbbbbb), 0x66666666);
						printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
						if(stop_on_error)
							exit(-1);
					}
				...
				{
					if((temp1 != cp_table[i].result_sp) || (temp2 != 0x66666666))
					{
						printf("SP Command Register (NO IMASK) Comparison Failure: %s\n", cp_table[i].name);
						printf("    Expected: %08lx(ms), %08lx(ls)\n", cp_table[i].result_sp, 0x66666666);
						printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
						if(stop_on_error)
							exit(-1);
					}
			...
			for(i = 0; i ==0; i++)	/* special loop for sincos instructions */
			/*for(i = 0; sincosp_table[i].name; i++) */	/* special loop for sincos instructions */
			{
				if(sincosp_table[i].op_sp == 0)
					continue;
				if(verbose_flag)
					printf("  Testing single precision %s\n", sincosp_table[i].name);
				wrt_fp_op(PUT_REG_MS, 1, 0xbbbbbbbb);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 1, 0x66666666);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 2, sincosp_table[i].r2_sp);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 2, 0x66666666);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 3, sincosp_table[i].r3_sp);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 3, 0xaaaaaaaa);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 4, 0xdddddddd);
				...
				ck_stat(ST_DONTCARE);
					/* for inexact restore, use the same reg for
					   operand and result */
				c_wrt_fp_op(sincosp_table[i].op_sp, 1+k, 2, 3, 4);
				stat = ck_stat(sincosp_table[i].status);
				if(stat != sincosp_table[i].status)
				{
					printf("Incorrect Status for %s, Expected: %01lx, Returned: %01lx\n", sincosp_table[i].name, sincosp_table[i].status, stat);
					if(stop_on_error)
						exit(-1);
				}
				rd_fp_op(GET_REG_MS, 1+k, &temp1);
				...
				if((stat > ST_FINITEINEXACT) || ((stat == ST_FINITEINEXACT) && (fpa->fp_imask & FPA_INEXACT)))
				{
					if((temp1 != (k?sincosp_table[i].r2_sp:0xbbbbbbbb)) || (temp2 != 0x66666666))
					{
						printf("SP Comparison Failure: %s: sin result\n", sincosp_table[i].name);
						printf("    Expected: %08lx(ms), %08lx(ls)\n", (k?sincosp_table[i].r2_sp:0xbbbbbbbb), 0x66666666);
						printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
						if(stop_on_error)
							exit(-1);
					}
				...
				{
					if((temp1 != sincosp_table[i].result_sp) || (temp2 != 0x66666666))
					{
						printf("SP Comparison Failure: %s: sin result\n", sincosp_table[i].name);
						printf("    Expected: %08lx(ms), %08lx(ls)\n", sincosp_table[i].result_sp, 0x66666666);
						printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
						if(stop_on_error)
							exit(-1);
					}
				...
				{
					if((temp1 != sincosp_table[i].r4_sp) || (temp2 != 0xaaaaaaaa))
					{
						printf("SP Comparison Failure: %s: cosin result\n", sincosp_table[i].name);
						printf("    Expected: %08lx(ms), %08lx(ls)\n", sincosp_table[i].r4_sp, 0xaaaaaaaa);
						printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
						if(stop_on_error)
							exit(-1);
					}
	...
	for(k = 0; k < 2; k++)
	{
		for(fpa->fp_imask &= ~FPA_INEXACT, j = 0; j < 2; j++ , fpa->fp_imask |= FPA_INEXACT)
		{
			...
			for(i = 0; cp_table[i].name; i++)
			{
				...
				wrt_fp_op(PUT_REG_LS, 1, 0x99999999);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 2, cp_table[i].r2_ms);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 2, cp_table[i].r2_ls);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 3, cp_table[i].r3_ms);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 3, cp_table[i].r3_ls);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 4, cp_table[i].r4_ms);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 4, cp_table[i].r4_ls);
				ck_stat(ST_DONTCARE);
				c_wrt_fp_op(cp_table[i].op_dp, 1+k, 2, 3, 4);
				stat = ck_stat(cp_table[i].status);
				if(stat != cp_table[i].status)
				{
					printf("Incorrect Status for %s, Expected: %01lx, Returned: %01lx\n", cp_table[i].name, cp_table[i].status, stat);
				...
				if((stat > ST_FINITEINEXACT) || ((stat == ST_FINITEINEXACT) && (fpa->fp_imask & FPA_INEXACT)))
				{
					if((temp1 != (k?cp_table[i].r2_ms:0x77777777)) || (temp2 != (k?cp_table[i].r2_ls:0x99999999)))
					{
						printf("DP Comparison Failure: %s\n", cp_table[i].name);
						printf("    Expected: %08lx(ms), %08lx(ls)\n", (k?cp_table[i].r2_ms:0x77777777), (k?cp_table[i].r2_ls:0x99999999));
						printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
						if(stop_on_error)
							exit(-1);
					}
				...
				{
					if((temp1 != cp_table[i].result_ms) || (temp2 != cp_table[i].result_ls))
					{
						printf("DP Comparison Failure: %s\n", cp_table[i].name);
						printf("    Expected: %08lx(ms), %08lx(ls)\n", cp_table[i].result_ms, cp_table[i].result_ls);
						printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
						if(stop_on_error)
							exit(-1);
					}
			...
			for(i = 0; sincosp_table[i].name; i++)	/* for sincos instructions */
			{
				if(sincosp_table[i].op_dp == 0)
					continue;
				if(verbose_flag)
					printf("  Testing double precision %s\n", sincosp_table[i].name);
				wrt_fp_op(PUT_REG_MS, 1, 0x77777777);
				...
				wrt_fp_op(PUT_REG_LS, 1, 0x99999999);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 2, sincosp_table[i].r2_ms);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 2, sincosp_table[i].r2_ls);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 3, sincosp_table[i].r3_ms);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 3, sincosp_table[i].r3_ls);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_MS, 4, 0xdddddddd);
				ck_stat(ST_DONTCARE);
				wrt_fp_op(PUT_REG_LS, 4, 0x66666666);
				ck_stat(ST_DONTCARE);
				c_wrt_fp_op(sincosp_table[i].op_dp, 1+k, 2, 3, 4);
				stat = ck_stat(sincosp_table[i].status);
				if(stat != sincosp_table[i].status)
				{
					printf("Incorrect Status for %s, Expected: %01lx, Returned: %01lx\n", sincosp_table[i].name, sincosp_table[i].status, stat);
				...
				if((stat > ST_FINITEINEXACT) || ((stat == ST_FINITEINEXACT) && (fpa->fp_imask & FPA_INEXACT)))
				{
					if((temp1 != (k?sincosp_table[i].r2_ms:0x77777777)) || (temp2 != (k?sincosp_table[i].r2_ls:0x99999999)))
					{
						printf("DP Comparison Failure: %s: sin result\n", sincosp_table[i].name);
						printf("    Expected: %08lx(ms), %08lx(ls)\n", (k?sincosp_table[i].r2_ms:0x77777777), (k?sincosp_table[i].r2_ls:0x99999999));
						printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
						if(stop_on_error)
							exit(-1);
					}
				...
				{
					if((temp1 != sincosp_table[i].result_ms) || (temp2 != sincosp_table[i].result_ls))
					{
						printf("DP Comparison Failure: %s: sin result\n", sincosp_table[i].name);
						printf("    Expected: %08lx(ms), %08lx(ls)\n", sincosp_table[i].result_ms, sincosp_table[i].result_ls);
						printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
						if(stop_on_error)
							exit(-1);
					}
				...
				{
					if((temp1 != sincosp_table[i].r4_ms) || (temp2 != sincosp_table[i].r4_ls))
					{
						printf("DP Comparison Failure: %s: cosin result\n", sincosp_table[i].name);
						printf("    Expected: %08lx(ms), %08lx(ls)\n", sincosp_table[i].r4_ms, sincosp_table[i].r4_ls);
						printf("    Returned: %08lx(ms), %08lx(ls)\n", temp1, temp2);
						if(stop_on_error)
							exit(-1);
					}
...
long stat;
	...
	if(!quiet_flag)
		printf("Starting  Test of Single Precision Matrix Operations\n");
	for(i = 0; mp_table[i].name; i++)
	{
		if(mp_table[i].op_sp == 0)
			continue;
		if(verbose_flag)
			printf("  Testing single precision %s\n", mp_table[i].name);
		fill(mp_table[i].start);
		c_wrt_fp_op(mp_table[i].op_sp, 0x10, 0x0, 4, 4);
		if(verbose_flag)
			printf("  Address: 0x%x\n", mp_table[i].op_sp);
		stat = ck_stat(mp_table[i].status);
		ckfill(mp_table[i].result_sp);
	}
	if(!quiet_flag)
		printf("Finishing Test of Single Precision Matrix Operations\n");
	if(!quiet_flag)
	...
	for(i = 0; mp_table[i].name; i++)
	{
		if(mp_table[i].op_dp == 0)
			continue;
		if(verbose_flag)
			printf("  Testing double precision %s\n", mp_table[i].name);
		fill(mp_table[i].start);
		c_wrt_fp_op(mp_table[i].op_dp, 0x10, 0x0, 4, 4);
		stat = ck_stat(mp_table[i].status);
		ckfill(mp_table[i].result_dp);
	}
	if(!quiet_flag)
		printf("Finishing Test of Double Precision Matrix Operations\n");
}
...
fpe_error()
{
	...
	if(got_fpe_error > 1000)
	{
		if (fpa_type == 0)
			...
			printf("The TISTATUS register reads: %08lx\n", fpa->fp_wstatus_stable);
