#ifndef lint
static  char sccsid[] = "@(#)conflib.c 1.1 92/08/05 Copyr 1986 Sun Micro";
#endif
...
Done:
	*str2 = 0;
	/* restore_bits(pw, &rectsaved, bitmap_under); */
...
Done:
	/* restore_bits(fs->fs_pixwin, &rectsaved, bitmap_under); */
